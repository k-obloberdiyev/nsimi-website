...
export const NewsDetailPage: React.FC = () => {
  ...
  useEffect(() => {
    if (article) {
      document.title = `${article.title} – Navoiy shahar 1-son ixtisoslashtirilgan maktab-internati`;
    } else {
      document.title = 'Yangilik topilmadi – Navoiy shahar 1-son ixtisoslashtirilgan maktab-internati';
    }
    window.scrollTo(0, 0);
  }, [article, slug]);
