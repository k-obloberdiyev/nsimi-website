...
export const ContactPage: React.FC = () => {
  ...
  useEffect(() => {
    document.title = 'Aloqa – Navoiy shahar 1-son ixtisoslashtirilgan maktab-internati';
    window.scrollTo(0, 0);
  }, []);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-5 flex flex-col justify-between">
              ...
              <div className="mt-8 rounded-2xl overflow-hidden border border-gray-200 shadow-sm aspect-[16/9] bg-gray-100">
                <iframe
                  title="Navoiy shahar 1-son ixtisoslashtirilgan maktab-internati joylashuvi"
