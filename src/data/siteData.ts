...
export const siteContactInfo = {
  schoolName: "Navoiy shahar 1-sonli Ixtisoslashtirilgan maktab internati",
  organization: "Prezident ta'lim muassasalari agentligi tizimidagi Navoiy shahar 1-sonli Ixtisoslashtirilgan maktab internati",
...
export const aboutPageData = {
  ...
  methodDescription: "Navoiy shahar 1-sonli Ixtisoslashtirilgan maktab internati butun O'zbekistonda o'zining a'lo bilimli o'quvchilar yetishtirib berishi bilan nom qozongan. Bizning maktabimizda tajribali va fidoyi o'qituvchilar ilg'or metodlar bilan dars berishadi.",
